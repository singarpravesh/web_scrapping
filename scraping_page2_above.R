...
# navigate to page 2
remDr$navigate("https://www.99acres.com/property-in-kolkata-ffid-page-2")

# Get all the urls in page 2
urls2 <- remDr$findElements(using = "xpath", "//*[@class='ellipsis']") |> 
...
# navigate to page 3
remDr$navigate("https://www.99acres.com/property-in-kolkata-ffid-page-3")

# Get all the urls in page 3
remDr$setTimeout(type = "implicit", milliseconds = 20000)  # Wait to load the page
urls3 <- remDr$findElements(using = "xpath", "//*[@class='ellipsis']") |> 
  sapply(function(x){x$getElementAttribute("href")}[[1]])
remDr$closeWindow()
rD$server$stop()
...
# navigate to page 4
remDr$navigate("https://www.99acres.com/property-in-kolkata-ffid-page-4")

# Get all the urls in page 4
urls4 <- remDr$findElements(using = "xpath", "//*[@class='ellipsis']") |> 
  sapply(function(x){x$getElementAttribute("href")}[[1]])
remDr$closeWindow()
rD$server$stop()
...
# navigate to page 4
remDr$navigate("https://www.99acres.com/property-in-kolkata-ffid-page-5")

# Get all the urls in page 4
urls5 <- remDr$findElements(using = "xpath", "//*[@class='ellipsis']") |> 
  sapply(function(x){x$getElementAttribute("href")}[[1]])
remDr$closeWindow()
rD$server$stop()
...
# navigate to page 6
remDr$navigate("https://www.99acres.com/property-in-kolkata-ffid-page-8")

# Get all the urls in page 4
urls8 <- remDr$findElements(using = "xpath", "//*[@class='ellipsis']") |> 
  sapply(function(x){x$getElementAttribute("href")}[[1]])
remDr$closeWindow()
rD$server$stop()
...
# navigate to page 6
remDr$navigate("https://www.99acres.com/property-in-kolkata-ffid-page-9")

# Get all the urls in page 4
urls9 <- remDr$findElements(using = "xpath", "//*[@class='ellipsis']") |> 
  sapply(function(x){x$getElementAttribute("href")}[[1]])
remDr$closeWindow()
rD$server$stop()
...
# navigate to page 6
remDr$navigate("https://www.99acres.com/property-in-kolkata-ffid-page-10")

# Get all the urls in page 4
urls10 <- remDr$findElements(using = "xpath", "//*[@class='ellipsis']") |> 
  sapply(function(x){x$getElementAttribute("href")}[[1]])
remDr$closeWindow()
rD$server$stop()
...
# navigate to page 6
remDr$navigate("https://www.99acres.com/property-in-kolkata-ffid-page-11")

# Get all the urls in page 4
urls11 <- remDr$findElements(using = "xpath", "//*[@class='ellipsis']") |> 
  sapply(function(x){x$getElementAttribute("href")}[[1]])
remDr$closeWindow()
rD$server$stop()
...
# navigate to page 6
remDr$navigate("https://www.99acres.com/property-in-kolkata-ffid-page-12")

# Get all the urls in page 4
urls12 <- remDr$findElements(using = "xpath", "//*[@class='ellipsis']") |> 
  sapply(function(x){x$getElementAttribute("href")}[[1]])
remDr$closeWindow()
rD$server$stop()
